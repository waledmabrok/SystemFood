...
class _ProductsScreenState extends State<ProductsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final products = await _productRepo.getAll(categoryId: _selectedCategoryId, activeOnly: true);
  ...
  List<Product> get _filteredProducts {
    ...
    return _products.where((p) => p.name.contains(_searchQuery)).toList();
  }
...
class _ProductDialogState extends State<ProductDialog> {
  ...
  void initState() {
    ...
    _stockCtrl = TextEditingController(text: p != null ? p.stock.toStringAsFixed(0) : '1000');
